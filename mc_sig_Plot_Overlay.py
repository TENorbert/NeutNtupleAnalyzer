...
g0 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau250.root")
g1 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau500.root")
g2 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau1000.root")
g3 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau2000.root")
g4 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau3000.root")
g5 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau4000.root")
g6 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau6000.root")
g7 =  TFile("/data/whybee0b/user/norbert/GMSBAnalysis/MC2012/GEN/mc-GEN-GMSB-Ntuples/gmsb-L180-Ctau12000.root")
...
# ProperLifetime
hist_0 = g0.Get("TestHepMCEvt/NeutdT") ## NeutdT Neutralino Transverse distance travelled
hist_1 = g1.Get("TestHepMCEvt/NeutdT")
hist_2 = g2.Get("TestHepMCEvt/NeutdT") 
hist_3 = g3.Get("TestHepMCEvt/NeutdT") 
hist_4 = g4.Get("TestHepMCEvt/NeutdT") 
hist_5 = g5.Get("TestHepMCEvt/NeutdT") 
histdl_6 = g6.Get("TestHepMCEvt/NeutdT") 
...
# Label Axis
hist_1.GetXaxis().SetTitle("Neutralino Transverse Distance Traveled[mm]")
...
# Label Axis
hist_7.GetXaxis().SetTitle("Photon Time(GEN)[ns]")
hist_7.GetYaxis().SetTitle("Events")
...
#Add Legend
leg0 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg0.SetBorderSize(1)
leg0.SetFillColor(0)
leg0.AddEntry(evt_met1,"#Lambda=180 TeV, #tau = 6.7 ns","l")
leg0.AddEntry(evt_met2,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg0.AddEntry(evt_met0,"#Lambda=180 TeV, #tau = 20.0 ns","l")
leg0.AddEntry(evt_metgjet,"#gamma + Jet, 120 < #hat{P_{T}}^{#gamma} < 170","l")
...
nph2.Draw("sames")
nphgjet.Draw("sames")
nph0.GetXaxis().SetRangeUser(0, 10)
#Add Legend
leg1 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg1.SetBorderSize(1)
leg1.SetFillColor(0)
leg1.AddEntry(nph1,"#Lambda=180 TeV, #tau = 6.7 ns","l")
leg1.AddEntry(nph2,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg1.AddEntry(nph0,"#Lambda=180 TeV, #tau = 20.0 ns","l")
leg1.AddEntry(nphgjet,"#gamma + Jet, 120 < #hat{P_{T}}^{#gamma} < 170","l")
...
njet2.Draw("sames")
njetgjet.Draw("sames")
njet0.GetXaxis().SetRangeUser(0, 16)
#Add Legend
leg2 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg2.SetBorderSize(1)
leg2.SetFillColor(0)
leg2.AddEntry(njet1,"#Lambda=180 TeV, #tau = 6.7 ns","l")
leg2.AddEntry(njet2,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg2.AddEntry(njet0,"#Lambda=180 TeV, #tau = 20.0 ns","l")
leg2.AddEntry(njetgjet,"#gamma + Jet, 120 < #hat{P_{T}}^{#gamma} < 170","l")
...
#cmstex.DrawLatex(0.43, 0.967, CoMEr.c_str());
#cmstex.DrawLatex(0.75, 0.96, lint.c_str());
cmstex.DrawLatex(0.35, 0.865, "CMS");
cmstex.DrawLatex(0.35, 0.832, "Preliminary");
cmstex.DrawLatex(0.72, 0.920, lint);


c3 = TCanvas("c3", "Neutralino Transverse Decay Distance", 800, 800)
c3.SetGridx();
c3.SetGridy();
...
hist_1.SetTitle("Neutralino Transverse Decay Distance")
hist_1.Draw()
hist_5.Draw("sames")
hist_4.Draw("sames")
hist_3.Draw("sames")
...
leg3.SetFillColor(0)
leg3.AddEntry(hist_1,"#Lambda=180 TeV, #tau = 1.7 ns","l")
leg3.AddEntry(hist_2,"#Lambda=180 TeV, #tau = 3.3 ns ","l")
leg3.AddEntry(hist_3,"#Lambda=180 TeV, #tau = 6.7 ns","l")
leg3.AddEntry(hist_4,"#Lambda=180 TeV, #tau = 10.0 ns","l")
leg3.AddEntry(hist_5,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg3.AddEntry(histdl_6,"#Lambda=180 TeV, #tau = 20.0 ns","l")
...
hist_7.SetTitle("Photon Arrival Time[ns]")
hist_7.Draw()
#hist_6.Draw("sames")
hist_11.Draw("sames")
hist_10.Draw("sames")
...
hist_8.Draw("sames")
hist_12.Draw("sames")
hist_7.GetXaxis().SetRangeUser(0.0, 300.0)
#hist_12.GetYaxis().SetRangeUser(0.0, 10000.0)
#Add Legend
leg4 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg4.SetBorderSize(1)
leg4.SetFillColor(0)
leg4.AddEntry(hist_7,"#Lambda=180 TeV, #tau = 1.7 ns","l")
leg4.AddEntry(hist_8,"#Lambda=180 TeV, #tau = 3.3 ns","l")
leg4.AddEntry(hist_9,"#Lambda=180 TeV, #tau = 6.7 ns","l")
leg4.AddEntry(hist_10,"#Lambda=180 TeV, #tau = 10.0 ns","l")
leg4.AddEntry(hist_11,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg4.AddEntry(hist_12,"#Lambda=180 TeV, #tau = 20.0 ns","l")
...
pthist_1.Draw("sames")
pthist_6.Draw("sames")
pthist_0.GetXaxis().SetRangeUser(0.0, 1500.0)

#Add Legend
leg5 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg5.SetBorderSize(1)
leg5.SetFillColor(0)
leg5.AddEntry(pthist_4,"#Lambda=100 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_3,"#Lambda=120 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_2,"#Lambda=140 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_1,"#Lambda=160 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_0,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_5,"#Lambda=220 TeV, #tau = 13.3 ns","l")
leg5.AddEntry(pthist_6,"#Lambda=300 TeV, #tau = 13.3 ns","l")
...
phpthist_0.GetXaxis().SetRangeUser(0.0, 1400.0)
#Add Legend
leg6 = TLegend( 0.55, 0.60, 0.90, 0.90)
leg6.SetBorderSize(1)
leg6.SetFillColor(0)
leg6.AddEntry(phpthist_4,"#Lambda=100 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_3,"#Lambda=120 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_2,"#Lambda=140 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_1,"#Lambda=160 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_0,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_5,"#Lambda=220 TeV, #tau = 13.3 ns","l")
leg6.AddEntry(phpthist_6,"#Lambda=300 TeV, #tau = 13.3 ns","l")
...
leg7.SetFillColor(0)
leg7.AddEntry(betahist_4,"#Lambda=100 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_3,"#Lambda=120 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_2,"#Lambda=140 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_1,"#Lambda=160 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_0,"#Lambda=180 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_5,"#Lambda=260 TeV, #tau = 13.3 ns","l")
leg7.AddEntry(betahist_6,"#Lambda=300 TeV, #tau = 13.3 ns","l")
...
c0.SetLogy(1)
c0.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-MET_" + Lambda + " TeV" + ".png")
c0.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-MET_" + Lambda + " TeV" + ".pdf")
c0.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-MET_" + Lambda + " TeV" + ".eps")

### Number of Photons
c1.SetLogy(1)
c1.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfPhotons_" + Lambda + " TeV" + ".png")
c1.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfPhotons_" + Lambda + " TeV" + ".pdf")
c1.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfPhotons_" + Lambda + " TeV" + ".eps")

### Number of Jets
c2.SetLogy(1)
c2.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfJets_" + Lambda + "TeV" + ".png")
c2.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfJets_" + Lambda + "TeV"  + ".pdf")
c2.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfJets_" + Lambda + "TeV"  + ".eps")

### Neutralino Proper Decay Length
c3.SetLogy(1)
c3.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Proper-DecayLength_" + Lambda + "TeV" + ".png")
c3.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Proper-DecayLength_" + Lambda + "TeV" + ".pdf")
c3.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Proper-DecayLength_" + Lambda + "TeV" + ".eps")

### Photon Time
c4.SetLogy(1)
c4.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-GEN-Time_"+ Lambda + "TeV" +".png")
c4.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-GEN-Time_"+ Lambda + "TeV" +".pdf")
c4.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-GEN-Time_"+ Lambda + "TeV" +".eps")

### Neutralino Pt
c5.SetLogy(1)
c5.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Pt_" + ctau + ".png")
c5.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Pt_" + ctau + ".pdf")
c5.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Neutralino-Pt_" + ctau +".eps")

### Photon Pt
c6.SetLogy(1)
c6.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-Pt_" + ctau + ".png")
c6.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-Pt_" + ctau + ".pdf")
c6.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-Photon-Pt_" + ctau +".eps")

### Number Of Gravitinos
c7.SetLogy(1)
c7.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfGravitinos_" + ctau + ".png")
c7.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfGravitinos_" + ctau + ".pdf")
c7.SaveAs("/home/user1/norbert/public_html/LL_Neutral_Parts/MC_STUDY/GMSB-SPS8-MODEL-EVENT-KINEMATICS/GMSB-SPS8-MODEL-NumberOfGravitinos_" + ctau + ".eps")
