...
#### Comparing ALL, EB Vs EE time
time_all = f1.Get("NeutKin/my.h_Time")
time_EB = f1.Get("NeutKin/my.pho_timeEB")
time_EE = f1.Get("NeutKin/my.pho_timeEE")
...
# For Seed Time
time_all.SetLineColor(1)
time_EB.SetLineColor(4)
time_EE.SetLineColor(2)
...
# Choose Line Style
time_all.SetLineStyle(2)
time_EB.SetLineStyle(8)
time_EE.SetLineStyle(1)
...
#Choose LineWidth
time_all.SetLineWidth(2)
time_EB.SetLineWidth(2)
time_EE.SetLineWidth(2)
...
# Label Axis
time_all.GetXaxis().SetTitle("ECAL Time[ns]")
time_all.GetYaxis().SetTitle("Entries")
time_all.GetXaxis().SetTitleOffset(1.4);
time_all.GetYaxis().SetTitleOffset(1.4);
time_all.GetXaxis().SetLabelSize(textsize);
time_all.GetYaxis().SetLabelSize(textsize);
...
time_all.SetTitle("Photon Time")
time_all.Draw()
time_EB.Draw("sames")
time_EE.Draw("sames")
time_all.GetXaxis().SetRangeUser(ll, lh)
#Add Legend
lg1 = TLegend( 0.60, 0.75, 0.90, 0.90)
lg1.SetBorderSize(1)
lg1.SetFillColor(0)
lg1.AddEntry(time_all,"ALL ECALL","l")
lg1.AddEntry(time_EB,"EB, |#eta| < 1.47","l")
lg1.AddEntry(time_EE,"EE, 1.47 < #eta < 3.0","l")
lg1.SetTextSize(0.029)
lg1.SetHeader("")
lg1.Draw()

Lint= s_lumi + CoMEr
cmstex1 = TLatex()
cmstex1.SetTextAlign(12)
cmstex1.SetTextSize(0.035)
cmstex1.SetTextFont(22)
cmstex1.SetTextAngle(0)
cmstex1.SetTextColor(kBlack)
cmstex1.SetNDC()
#cmstex1.DrawLatex(0.155, 0.967, "CMS Preliminary");
#cmstex1.DrawLatex(0.43, 0.967, CoMEr.c_str());
#cmstex1.DrawLatex(0.75, 0.96, lint.c_str());
cmstex1.DrawLatex(0.20, 0.865, "CMS");
cmstex1.DrawLatex(0.20, 0.832, "Preliminary");
cmstex1.DrawLatex(0.72, 0.920, Lint);
...
gPad.SetLogy()
c3.SaveAs("Photon_W_AveSCTime_Distribution_VsJetMultiplicity.png")
c3.SaveAs("Photon_W_AveSCTime_Distribution_VsJetMultiplicity.pdf")



gPad.SetLogy()
c4.SaveAs("/home/user1/norbert/public_html/ECALTiming/ZeeTimePerformance/ECAL-TIME-2013-2014/PhotonTimeALLVsEBVsEE.png")
c4.SaveAs("/home/user1/norbert/public_html/ECALTiming/ZeeTimePerformance/ECAL-TIME-2013-2014/PhotonTimeALLVsEBVsEE.pdf")
c4.SaveAs("/home/user1/norbert/public_html/ECALTiming/ZeeTimePerformance/ECAL-TIME-2013-2014/PhotonTimeALLVsEBVsEE.eps")
